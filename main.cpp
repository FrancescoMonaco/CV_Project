...
const std::string path= "C:/Users/miche/OneDrive/Desktop/sport/Sport_scene_dataset";
// ***STRING CONSTANTS***
...
int main(int argc, char** argv)
{
    ...
    std::string rel_path = path;// argv[1];
    ...
    for (size_t k = 0; k < images.size(); k++) {
        ...
        //choose segmentaion approach
        /*
        * if apprach=true perform standard segmentation
